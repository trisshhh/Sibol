                                ...
                                <div class="offcanvas-body p-3 p-xl-0">
                                    <div class="rounded-3 pb-0 p-3 w-100">
                                        ...
                                        <div class="list-group list-group-dark list-group-borderless">
                                            <a class="list-group-item active" href="profile.php"><i class="bi bi-ui-checks-grid me-2"></i>Overview</a>
                                            <a class="list-group-item" href="profile-trainings.php"><i class="bi bi-file-earmark-text me-2"></i>Trainings and Jobs</a>
                                            <a class="list-group-item" href="profile-edit.php"><i class="bi bi-pencil-square me-2"></i>Edit Profile</a>
                                            <a class="list-group-item" href="profile-delete.php"><i class="bi bi-trash me-2"></i>Delete Profile</a>
